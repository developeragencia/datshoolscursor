...
export default function LoginComplete() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      // Always redirect to dashboard for clients
        ...
        <div className="text-center mb-8">
          <Link href="/">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Dashtools</h1>
                <p className="text-sm text-gray-600">Plataforma de Rastreamento</p>
              </div>
            </div>
          </Link>
        </div>
