        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center mb-4">
              <div className="relative flex items-center justify-center w-10 h-10 rounded-lg bg-white/20">
                <Zap className="w-6 h-6 text-white" />
              </div>
              <span className="ml-2 text-lg font-semibold">Dashtools</span>
            </Link>
            <address className="not-italic text-sm text-gray-300 max-w-xs">
              Plataforma de Rastreamento<br />
              e Análise de Campanhas<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/pricing" className="text-gray-300 hover:text-white transition">Preços</Link></li>
                <li><Link href="/integrations" className="text-gray-300 hover:text-white transition">Integrações</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/termos" className="text-gray-300 hover:text-white transition">Termos e Condições</Link></li>
                <li><Link href="/privacidade" className="text-gray-300 hover:text-white transition">Política de Privacidade</Link></li>
                <li><Link href="/cookies" className="text-gray-300 hover:text-white transition">Política de Cookies</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="https://wa.me/5524992281288?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20o%20Dashtools!"
                  target="_blank"
        ...
        <div className="mt-12 pt-8 border-t border-blue-800 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0 md:mr-6">
              © {new Date().getFullYear()} Dashtools | Todos os direitos reservados
            </p>
          </div>
